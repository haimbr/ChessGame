...
namespace chess
{
    ...
    class ChessGame
    {
        ...
        public ChessGame()
        {
            ...
            boardsHistory = this.ToString() + "fffffff";
        ...
        public void play()
        {
            Console.WriteLine("In order to make a move enter current location and desired location (for example a2a3)  \n");
            ...
            while (true)
            {
                while (true)
                {
                    userInput(location, destination, color);
                ...
                Console.WriteLine(this);
                if(moveStatus == 10)
                    Console.WriteLine("****** check mett the " + (color ? "white" : "black") + " player won the game *******");
                if(moveStatus == 9)
        ...
        public int move(int locationY, int locationX, int destinationY, int destinationX, bool checkMoveAvailable)
        {
            ...
            // saves the original values ​​in case that required to return the original values.
            ...
            // Checking if the king is under threat or if the function was called just to check if the move is valid but not required to perform the move if so returns the ChessPiece original position.
        ...
        public void userInput(ChessPiece location, ChessPiece destination, bool color)
        {
            int locationY, locationX, destinationY, destinationX;
            while (true)
            {
                Console.WriteLine("Enter current location and desired location");
                ...
                if ((locationX == 9) || (destinationX == 9) || (st[1] != '1' && st[1] != '2' && st[1] != '3' && st[1] != '4' && st[1] != '5' && st[1] != '6' && st[1] != '7' && st[1] != '8') ||
                        (st[3] != '1' && st[3] != '2' && st[3] != '3' && st[3] != '4' && st[3] != '5' && st[3] != '6' && st[3] != '7' && st[3] != '8'))
                {
                    Console.WriteLine("Incorrect input!");
                    continue;
                }

                locationY = 8 - int.Parse(st[1] + "");
                destinationY = 8 - int.Parse(st[3] + "");

                if (board[locationY, locationX] == null || board[locationY, locationX].getColor() != color)
                {
                    Console.WriteLine("You can only move with the " + (color ? "white" : "black") + " tools");
                    continue;
                }
